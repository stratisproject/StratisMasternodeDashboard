namespace Stratis.FederatedSidechains.AdminDashboard.Settings
{
    public class DefaultEndpointsSettings
    {
        ...
        {
            return $"{nameof(this.MainchainNode)}: {this.MainchainNode}; {nameof(this.SidechainNode)}: {this.SidechainNode}; {nameof(this.SidechainNodeType)}: {this.SidechainNodeType}; {nameof(this.EnvType)}: {this.EnvType}";
        }
    }
